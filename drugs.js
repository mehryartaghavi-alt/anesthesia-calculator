...
thiopental: {
    ...
    etomidate: {
        ...
        notes:
            "Useful when cardiovascular stability is particularly important."
    },
    ...
    ketamine: {
        ...
        notes:
            "Dose and route should be individualized according to indication and patient characteristics."
    },
...
sufentanil: {
    ...
    morphine: {
        ...
        notes:
            "Use caution in renal impairment because active metabolites may accumulate."
    },
    ...
    remifentanil: {
        ...
        notes:
            "Continuous monitoring and titration are required."
    },
    ...
    rocuronium: {
        ...
        notes:
            "Neuromuscular monitoring should guide repeated dosing and reversal."
    },
    ...
    vecuronium: {
        ...
        notes:
            "Use quantitative neuromuscular monitoring whenever available."
    },
    ...
    cisatracurium: {
        ...
        cautions: [
            "Anaphylaxis",
            "Prolonged blockade if not monitored"
        ],
        ...
        notes:
            "Organ-independent elimination is an important clinical feature."
    },
    ...
    succinylcholine: {
        ...
        indications: [
            "Rapid sequence intubation",
            "Short-duration neuromuscular blockade"
        ],
        ...
        notes:
            "Check contraindications and hyperkalemia risk before administration."
    },
    ...
    dexmedetomidine: {
        ...
        cautions: [
            "Bradycardia",
            "Hypotension",
            "Transient hypertension with loading"
        ],
        ...
        notes:
            "A loading dose is not mandatory in every clinical situation."
    },
    ...
    norepinephrine: {
        ...
        notes:
            "Titrate to blood pressure, perfusion and clinical response."
    },
...
/**
 * Return unique drug categories
 */
function getDrugCategories() {
    return [
        ...new Set(
            Object.values(DRUG_DATABASE)
...
/**
 * Return drugs belonging to a category
 */
...
/**
 * Return available administration types
 */
...
/**
 * Return dose definition for a drug
 */
 ...
 */
function normalizeWeightBasis(weightBasis) {
 ...
 * contains an automatic weight-based dose
 */
function hasAutomaticDose(definition) {
    ...
    if (
        definition.doseMin === null ||
        definition.doseMax === null
    ) {
        return false;
    }

    if (!definition.weightBasis) {
        return false;
    }
...
/*
   These functions intentionally remain global
   because drug-dose.html uses them directly.
*/
